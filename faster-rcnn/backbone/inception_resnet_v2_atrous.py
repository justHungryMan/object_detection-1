...
from backbone.inceptionresnetv2 import inceptionresnetv2_atrous

import backbone.base


class Inception_Resnet_V2_Atrous(backbone.base.Base):

    def __init__(self, pretrained: bool):
        super().__init__(pretrained)

    def features(self) -> Tuple[nn.Module, nn.Module, int, int]:
        model = inceptionresnetv2_atrous(pretrained=self._pretrained)
