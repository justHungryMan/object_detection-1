...
if __name__ == '__main__':
    def main():
        ...
        parser.add_argument('-p', '--probability_threshold', type=float, default=0.5, help='threshold of detection probability')
        ...
        args.checkpoint = '../outputs/checkpoints-{}/model-0.pth'.format(args.backbone)
        args.output = args.output+'/faster-rcnn_{}_det_{}'.format(args.backbone, args.input[8:])
