...
from arch_resnet import *
from arch_inception import *
from arch_mobilenet import *
import torchvision
...
class AuxiliaryConvolutions(nn.Module):
    ...
    def __init__(self, last_kernel):
        ...
        self.conv11_2 = nn.Conv2d(128, 256, kernel_size=last_kernel, padding=0)  # dim. reduction because padding = 0
...
class PredictionConvolutions(nn.Module):
    ...
    def forward(self, conv4_3_feats, conv7_feats, conv8_2_feats, conv9_2_feats, conv10_2_feats, conv11_2_feats):
        ...
        locs = torch.cat([l_conv4_3, l_conv7, l_conv8_2, l_conv9_2, l_conv10_2, l_conv11_2], dim=1)  # (N, 8732, 4) ->vgg net
                                                                                                    # (N, 4722 , 4) ->resnet
                                                                                                    # 8432 googlenet
...
class MultiBoxLayer(nn.Module):
    ...
    def forward(self, fms):
        ...
        for loc_layer, cls_layer, fm in zip(self.loc_layers, self.cls_layers, fms):
            ...
            cls_pred = cls_pred.permute(0,2,3,1).contiguous().view(loc_pred.size(0),-1,(self.num_classes+1))
...
class SSD300(nn.Module):
    ...
    def __init__(self, n_classes, backbone):
        ...
        self.n_classes = n_classes
        self.multibox = MultiBoxLayer(self.n_classes, self.num_anchors, self.in_planes)

        self.backbone = backbone
        self.last = 3
        if self.backbone == 'vggnet':
            self.base = VGGBase()
        elif self.backbone == 'resnet':
            self.base = resnet_base(depth=101) # depth 18, 34, 50, 101, 105
        elif self.backbone == 'googlenet':
            self.base = inception_v3()
        elif self.backbone == 'mobilenet':
            self.base = mobilenet_v2()

        self.aux_convs = AuxiliaryConvolutions(self.last)
    ...
    def forward(self, image):
        ...
        # print('conv4_3 ', conv4_3_feats.size(), 'conv7_feats ', conv7_feats.size())
    ...
    def create_prior_boxes(self):
        ...
        """
        if self.backbone == 'vggnet' or self.backbone == 'resnet' or self.backbone == 'mobilenet':
    ...
    def detect_objects(self, predicted_locs, predicted_scores, min_score, max_overlap, top_k):
        ...
        # print('{} {} {}'.format(n_priors ,predicted_locs.size(1) ,predicted_scores.size(1)))
        ...
        for i in range(batch_size):
            ...
            for c in range(1, self.n_classes):
                ...
                for box in range(class_decoded_locs.size(0)):
                    ...
                    b = (overlap[box] > max_overlap).type(torch.ByteTensor).to(device)
